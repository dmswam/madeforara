...
const musicOptions = [
    { value: './music/happy-birthday.mp3', label: 'ARA (Miễn phí)' },
    { value: './music/happybirthday.mp3', label: 'ARA (Phiên bản 2)' },
    { value: './music/happybirthday_domixi.mp3', label: 'ARA (Độ Mixi)' },
    { value: './music/hbdmusic1.mp3', label: 'ARA (Mèo UIA)' },
    { value: './music/music.mp3', label: 'ARA (Instrumental)' },
...
applySettingsButton.addEventListener('click', () => {
    ...
    settings.matrixText = document.getElementById('matrixText').value || 'ARA';
    ...
    settings.sequence = document.getElementById('sequenceText').value || 'AKU|SAYANG|KAMU|ARA|❤';
